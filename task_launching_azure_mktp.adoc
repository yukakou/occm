...
* Choose a VM size that has at least 4 vCPUs and 14 GB of RAM. We recommend DS3 v2.
+
...
+
link:reference_security_groups_azure.html[Learn more about security group rules for the Connector].
...
The Connector now has the permissions that it needs to deploy and manage Cloud Volumes ONTAP in Azure. Cloud Manager will automatically use this Connector when you create new working environments. But if you have more than one Connector, you'll need to link:task_managing_connectors.html[switch between them].
