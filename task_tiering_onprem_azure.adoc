...
* To select a tiering polciy for multiple volumes, click the checkbox in the first column, click *Modify selected volumes*, select a tiering policy, and optionally adjust the cooling days.
+
