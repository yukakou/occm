...
"ce:GetTags"
+
These actions are included in the latest https://mysupport.netapp.com/info/web/ECMP11022837.html[Cloud Manager policy^]. New systems deployed from NetApp Cloud Central automatically include these permissions.
