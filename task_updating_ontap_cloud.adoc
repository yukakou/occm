...
NOTE: Cloud Manager doesn't support downgrading Cloud Volumes ONTAP to a previous version. Contact NetApp technical support for help with downgrades.
...
=== Advanced options for software upgrades
