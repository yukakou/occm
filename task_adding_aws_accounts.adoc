...
TIP: When you deploy Cloud Manager in AWS, Cloud Manager automatically adds a _Cloud Provider Account_ for the AWS account in which you deployed Cloud Manager. An initial Cloud Provider Account is not added if you manually installed the Cloud Manager software on an existing system.
