...
[role="quick-margin-para"]
See link:task_deploy_gfc_edge_instances.html[Deploying Global File Cache Edge instances^] to deploy the Global File Cache Edge instances in each remote location.
