...
+
NOTE: If Cloud Manager was not set up for encryption, the Cloud Manager Admin must set it up. See link:task_additional_setup.html#setting-up-ontap-cloud-encryption[Setting up Cloud Manager for ONTAP Cloud encryption in AWS].
