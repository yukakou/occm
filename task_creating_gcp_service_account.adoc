...
summary: Create a service account in Google Cloud so that Cloud Volumes ONTAP is ready to tier cold data and back up volumes to low-cost object storage in Google Cloud.
---
...
[.lead]
Create a service account in Google Cloud so that Cloud Volumes ONTAP is ready to tier cold data and back up volumes to low-cost object storage in Google Cloud.
