...
[cols="10,10,10,20,50",width=70%,options="header"]
|===
...
| API	| HTTPS | 443 | AWS API services | Assist with storage failover
| API	| UDP | 53 | AWS API services | Assist with storage failover

|===

NOTE: Rather than open these two ports, you can use a private endpoint instead.
