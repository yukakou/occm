...
| TCP | 8088 | Cloud Backup Service | API calls to the Cloud Backup Service
...
| Cloud Backup Service | TCP | 5010 | Intercluster LIF | Backup endpoint or restore endpoint | Back up and restore operations for the Backup to S3 feature
