...
[role="quick-margin-list"]
* *netapp-file*: for binding a Persistent Volume to single-node Cloud Volumes ONTAP systems
* *netapp-file-redundant*: for binding a Persistent Volume to Cloud Volumes ONTAP HA pairs
