...
=== image:number3.png[Number 3] Connect Cloud Volumes ONTAP to Kubernetes clusters

[role="quick-margin-para"]
Click *Connect to Cloud Volumes ONTAP* and follow the prompts. You can connect different clusters to different Cloud Volumes ONTAP systems and multiple clusters to the same Cloud Volumes ONTAP system.
