...
Before you complete these steps, you need to create a Cloud Volumes ONTAP system or link:task_discovering_ontap.html[discover an on-premises ONTAP cluster] from Cloud Manager.
