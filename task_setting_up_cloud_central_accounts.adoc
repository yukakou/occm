...
Set up the Cloud Central account associated with your Cloud Manager system so a user can access Cloud Manager and access the working environments in a workspace. Just add a user or add multiple users and workspaces.
...
A Connector enables Cloud Manager to manage resources and processes within your public cloud environment. You need to associate a Connector with workspaces so Workspace Admins can access those workspaces from Cloud Manager.
