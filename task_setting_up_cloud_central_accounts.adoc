...
When you create your first Cloud Volumes ONTAP working environment, Cloud Manager prompts you to create a Connector. A Connector enables Cloud Manager to manage resources and processes within your public cloud environment.

You need to associate a Connector with workspaces so Workspace Admins can access those workspaces from Cloud Manager.
