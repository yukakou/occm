...
keywords: account settings, workspaces, service connector, account admin, workspace admin, users, associate, disassociate, add user, add users, user management, administer, user, management, account, user account, user accounts
...
[.lead]
Each Cloud Manager system is associated with a _NetApp Cloud Central account_. Set up the Cloud Central account associated with your Cloud Manager system so users can access Cloud Manager and deploy Cloud Volumes ONTAP systems in workspaces.
