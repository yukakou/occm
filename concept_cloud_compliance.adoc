...
* Notify Cloud Manager users through email when files contain certain criteria (you define this criteria using link:task_managing_highlights.html[highlights^])
* View and modify Azure Information Protection (AIP) labels in your files (if you have link:task_managing_aip_labels.html#integrating-aip-labels-in-your-workspace[integrated AIP^])
