...
* link:task_tiering_storagegrid.html#preparing-your-ontap-clusters[Tiering data from on-premises ONTAP clusters to StorageGRID]
...
link:task_tiering_storagegrid.html#preparing-storagegrid[S3 permissions are needed].
