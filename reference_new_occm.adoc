...
The Cloud Storage Automation Report identifies several savings opportunities, including savings for unassociated EBS volumes and snapshots. Starting in version 3.4.2, Cloud Manager now shows you the list of unassociated volumes and snapshots and enables you to delete them.

The following image shows how you can access the list of volumes and snapshots:
...
The following image shows an example of how you can delete unassociated EBS volumes:
...
link:task_additional_setup.html#adding-additional-aws-accounts-to-cloud-manager[Adding additional AWS accounts to Cloud Manager]
