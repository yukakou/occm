...
The instance type for Cloud Manager is now t3.medium when deploying Cloud Manager in AWS from NetApp Cloud Central or from the AWS Marketplace. This change enables support in the latest AWS regions. The instance type was previously t2.medium.
