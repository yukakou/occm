...
IMPORTANT: Managed Service Identities are not supported in the Azure US Gov regions. You must link:task_creating_service_principal.html[grant Azure permissions to Cloud Manager using a service principal and credentials].
