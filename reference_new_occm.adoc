...
+
NOTE: Cloud Volumes ONTAP does need a connection to S3 through a VPC Endpoint to the S3 service. https://docs.netapp.com/us-en/occm/task_backup_to_s3.html#requirements[Learn more about the requirements].
