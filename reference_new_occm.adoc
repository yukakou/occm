...
== Update on Cloud Manager's transition to SaaS (15 July 2020)

We previously mentioned that we'll be introducing a link:concept_saas.html[software-as-a-service experience for Cloud Manager]. We'd like to provide two updates related to this change.
