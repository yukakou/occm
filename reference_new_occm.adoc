...
== Cloud Manager 3.7.3 (3 Sept 2019)

Cloud Manager 3.7.3 includes the following enhancements.

* <<General Availability of Cloud Volumes ONTAP in Google Cloud Platform>>
...
Cloud Volumes ONTAP is now generally available in GCP when you bring your own license (BYOL). A pay-as-you-go promotion is also available. The promotion offers free licenses for an unlimited number of systems and will expire at the end of September 2019.
