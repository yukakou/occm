...
Important notes about this enhancement:

* If you previously discovered your Kubernetes clusters through Cloud Manager, then you'll need to rediscover them.
* This Kubernetes feature isn't supported with on-prem ONTAP clusters. It’s supported with Cloud Volumes ONTAP only.
* These enhancements require additional permissions in Google Cloud:
