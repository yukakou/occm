...
== Cloud Manager 3.8.9 update (11 Oct 2020)

We have two Cloud Tiering updates for you:
...
* The standalone Cloud Tiering service has been retired. You should now access Cloud Tiering directly from Cloud Manager.
