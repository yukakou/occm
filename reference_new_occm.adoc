...
link:task_tiering.html[Learn how to get started].
...
link:task_.html[Learn how to sync data to Azure NetApp Files].
...
+
A subscription to the AWS Marketplace is required to continue scanning Amazon S3 after the free trial ends. link:.html[Learn how to subscribe].
+
https://cloud.netapp.com/???[Learn about pricing for Cloud Compliance with Amazon S3].
