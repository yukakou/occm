...
* <<iSCSI volumes from the user interface>>
...
=== Create iSCSI volumes for Cloud Volumes ONTAP

Cloud Manager now enables you to create iSCSI volumes for Cloud Volumes ONTAP directly from its user interface. !!! What about on-prem clusters? !!!
