...
We've enhanced how you manage your cloud resources. Each Cloud Manager system is now associated with a _NetApp Cloud Central account_.  The account enables multi-tenancy and is planned for other NetApp cloud data services in the future.
