...
Note that these enhancements require additional permissions in Google Cloud:
...
* You can now replace the Marketplace subscription that's currently associated with your cloud provider credentials. Learn how link:task_adding_aws_accounts.html[in AWS], link:task_adding_azure_accounts.html[in Azure], and link:task_adding_gcp_accounts.html[in GCP].
+
