...
== Cloud Manager 3.9.3 (7 Feb 2021)
...
The Monitoring service is now supported with Cloud Volumes ONTAP for Azure. The Monitoring service gives you complete visibility into your Cloud Volumes ONTAP infrastructure. Enable the service to monitor, troubleshoot, and optimize your Cloud Volumes ONTAP resources.

link:concept_monitoring.html[Learn more about the Monitoring service].

=== Cloud Tiering enhancements

* Aggregate fullness indication
