...
Cloud Manager now supports the Cloud Volumes ONTAP 9.5 release in Azure. For details about the release, see the https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_new_95.html[Cloud Volumes ONTAP 9.5 Release Notes^].
