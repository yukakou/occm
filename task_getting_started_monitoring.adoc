...
You need a new installation of Cloud Manager 3.8.4 or later in AWS or Azure, Cloud Volumes ONTAP in AWS or Azure, and you must be a new Cloud Insights customer.
