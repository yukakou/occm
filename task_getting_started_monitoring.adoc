...
+
image:screenshot_enable_monitoring.gif[[A screenshot that shows the Enable Monitoring icon which is available on the Canvas page after you select a working environment.]
