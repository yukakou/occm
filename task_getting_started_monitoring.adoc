...
* For AWS, you need a new installation of a Connector running version 3.8.4 or later.
* For Azure, you need a new installation of a Connector running version 3.9.3 or later.
...
* For Azure, you need a new installation of a Connector running version 3.9.3 or later.
+
A new installation is needed because a new infrastructure is required to enable the Monitoring service. This infrastructure is available starting with new installations of version 3.8.4 in AWS and version 3.9.3 in Azure.
