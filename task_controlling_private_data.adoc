...
== Using Highlights to view results in the Investigation page
...
image:screenshot_compliance_highlights_investigate.png[A screenshot of selecting Investigate Results from the Highlights tab in the Cloud Compliance dashboard.]
