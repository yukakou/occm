...
In addition to showing you the working environment and volume where the file resides, the metadata shows much more information. This information is useful if you are planning to create highlights because you can see all the information that you can filter your data.

There are also two items in this metadata that allow you to make changes:

* If you have integrated AIP labels with Cloud Compliance, you can assign a label to this file, or change to a different label if one already exists. See link:task_managing_aip_labels.html#assigning-aip-labels-manually[Assigning AIP labels manually^] for details.
...
* The _Highlights_ filter at the top of the Filters pane lists the custom filters that provide commonly requested combinations of filters; like a saved database query or Favorites list. Go link:task_managing_highlights.html[here^] to view the list of predefined highlights and to see how you can create your own custom highlights.
