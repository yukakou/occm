...
+
Then you have filters for working environment, storage repository, category, private data, file type, last modified date, file path, and whether the S3 object's permissions are open to public access.
+
