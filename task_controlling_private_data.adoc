...
* The controls at the top of each column allow you to sort the results by the values in that column.
...
* _Highlight filters_ at the bottom of the Filters pane list a group of predefined filters that provide commonly requested combinations of filters; like a saved query.

=== Predefined Highlights filters

The provided Highlights filters include:

[cols="25,35,30",width=85%,options="header"]
|===
| Name
| Description
| Logic
