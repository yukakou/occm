...
+
image:screenshot_create_data_broker.gif.gif["A screenshot showing the option to select a data broker in AWS, Azure, Google Cloud Platform, or an existing Linux host."]
