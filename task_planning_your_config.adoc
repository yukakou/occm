...
Sizing your Cloud Volumes ONTAP system can help you meet requirements for performance and capacity. It is important to remember the following:

* Identify the required system capacity so you can choose the right license type.
...
* You can let Cloud Manager manage a system's capacity for you, but if you want more control, be aware of the following:
...
== Choosing an Azure disk type and size

When you create volumes for Cloud Volumes ONTAP, you need to choose the underlying cloud storage that Cloud Volumes ONTAP uses as a disk. In Azure, you can choose a managed disk or a link:concept_data_tiering.html[tiered storage configuration] that uses managed disks as a performance tier and Azure Blob storage as a capacity tier. You should choose the configuration that meets your requirements for performance and cost.
