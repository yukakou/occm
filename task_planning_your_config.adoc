...
| Raw capacity limit | 2 TB | 10 TB 2+| 248 TB
...
. The actual maximum capacity may be less because of virtual machine limits: 56 TB for DS3, 120 TB for DS4 and DS13, and 248 TB for DS5 and DS14.
