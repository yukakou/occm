...
* https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_limits_aws_96.html[Storage limits for Cloud Volumes ONTAP 9.6 in AWS]
* https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_limits_azure_96.html[Storage limits for Cloud Volumes ONTAP 9.6 in Azure]
* https://docs.netapp.com/us-en/cloud-volumes-ontap/reference_limits_gcp_96.html[Storage limits for Cloud Volumes ONTAP 9.6 in GCP]
