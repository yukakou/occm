...
A managed identity is link:concept_accounts_azure.html[the initial Azure account] when you deploy Cloud Manager from NetApp Cloud Central. When you deployed Cloud Manager, Cloud Central created the Cloud Manager Operator role and assigned it to the Cloud Manager virtual machine.
