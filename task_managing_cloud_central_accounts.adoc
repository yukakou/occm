...
* *Cloud Compliance Viewer*: Can only view compliance information and generate reports for systems they have permission to access.

. If you selected Workspace Admin or Cloud Compliance Viewer, select one or more workspaces to associate with that user.
+
