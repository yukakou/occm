...
. From the top of Cloud Manager, click the *Account* drop-down and click *Manage Account Settings*.
+
image:screenshot_manage_account_settings.gif[A screenshot that shows the Manage Account Settings option that's available from the Account drop-down.]the Manage Account Settings option that's available from the Account drop-down.]
