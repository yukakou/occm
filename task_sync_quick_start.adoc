...
[role="quick-margin-para"]
Start your free trial from https://cloud.netapp.com[NetApp Cloud Central^], drag and drop your selections for the source and target, and follow the prompts to complete the setup. link:task_sync_creating_relationships.html[Learn more].
