...
Depending on your connectivity to AWS, you can utilize a private IP or public IP:

- A private IP works if you have a VPN and Direct Connect access to your VPC
- A public IP assigned to the host works in any networked scenario

In any case, you should secure your security group by allowing access from only authorized IPs or subnets.
