...
A Connector requires outbound internet access to contact the following endpoints to deploy and manage Cloud Volumes ONTAP in AWS:
...
A Connector requires outbound internet access to contact the following endpoints to deploy and manage Cloud Volumes ONTAP in Microsoft Azure:
...
A Connector requires outbound internet access to contact the following endpoints to deploy and manage Cloud Volumes ONTAP in GCP:
...
* If you create a Connector from Cloud Manager or from the marketplace images, refer to the following:
...
* If you install the Connector on an existing Linux host, see link:reference_cloud_mgr_reqs.html[Cloud Manager host requirements].
