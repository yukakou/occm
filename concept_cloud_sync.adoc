...
* link:task_licensing.html[Learn how to subscribe through AWS or Azure]
...
link:task_licensing.html[Learn how to purchase licenses and add them to Cloud Sync].
