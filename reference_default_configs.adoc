...
** The operating system for the Cloud Manager image is as follows:
...
* Two General Purpose SSD disks per node for boot and root data:
**	9.7: 160 GB for boot data and 220 GB for root data
**	9.6: 86 GB for boot data and 140 GB for root data
**	9.5: 45 GB for boot data and 140 GB for root data
