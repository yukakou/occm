...
* One Provisioned IOPS SSD disk for boot data, which is approximately 45 GB and 1,250 PIOPS

* One General Purpose SSD disk for root data, which is approximately 140 GB
