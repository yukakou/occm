...
* For GCP, you need to configure the subnet for Private Google Access and set up a service account. <<Requirements for tiering data in Google Cloud Platform,Learn more>>.
...
The permissions are included in the latest https://mysupport.netapp.com/info/web/ECMP11022837.html[Cloud Manager policy].
