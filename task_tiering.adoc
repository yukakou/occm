...
In AWS, you can change the tiering level so inactive data moves to the  _Standard-Infrequent Access_ storage class or to the _One Zone-Infrequent Access_ storage class after 30 days of inactivity.
