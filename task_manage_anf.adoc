...
. Azure NetApp Files must be setup by completing the following from the Azure portal:
...
. Cloud Manager must be setup as follows:

* Cloud Manager must be running in Azure, in the account where Azure NetApp Files was setup.
...
When your configuation is setup, Cloud Manager automatically displays Azure NetApp Files on the Working Environments page:
