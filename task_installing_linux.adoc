...
* If you want to deploy Cloud Volumes ONTAP in Azure, task_adding_cloud_accounts.html#setting-up-and-adding-azure-accounts-to-cloud-manager[set up an Azure account and then add it to Cloud Manager].
