...
.. If you want to deploy Cloud Volumes ONTAP in Azure, link:task_getting_started_azure.html#granting-azure-permissions-to-cloud-manager[create and set up a service principal in Azure Active Directory].
