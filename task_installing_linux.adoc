...
* Cloud Manager software accesses several URLs during installation. You must ensure that outbound internet access is allowed to those endpoints. Refer to link:reference_cloud_mgr_reqs.html[Cloud Manager host requirements for details].
