...
* The initial version of Global File Cache supported within Cloud Manager can be deployed using Cloud Volumes ONTAP as an HA pair in Azure.
+
Future releases will support additional storage options and additional cloud providers.
...
+
Consult your Global File Cache Solutions Engineer if you need to install multiple Cores in a Load Distributed design (Cold Standby).
