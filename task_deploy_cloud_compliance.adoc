...
+
*Note:* If you are using the old *Cloud Manager* subscription in Azure, you need to change to the new *NetApp Cloud Manager* subscription. See
...
. To verify your subscription has changed, hover the “i” above subscription in the Credentials card.
+
Now you can unsubscribe your old subscription from the Azure portal.

. Go to Software as a Service (SaaS), select the subscription and click *Unsubscribe*.
