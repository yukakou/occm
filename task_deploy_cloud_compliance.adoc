...
//
. Send an email to mailto:ng-contact-cloud-compliance@netapp.com?subject=Request%20for%20Compliance%20On-Premises%20Installer[the NetApp Cloud Compliance team] and we’ll send you the link to download the installer file.
