...
c. Enter the IP address or host name of the Cloud Manager Connector so it can be accessed by the Cloud Compliance instance.
...
* _cm_host_ = IP address or host name of the Cloud Manager Connector.
