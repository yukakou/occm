...
//
. Send an email to mailto:ng-contact-cloud-compliance@netapp.com?subject=Request-for-Compliance-On-Premises-Installer[the Cloud Compliance team at NetApp] and we’ll send you the link to download the installer file.
