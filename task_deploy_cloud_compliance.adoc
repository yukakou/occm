...
[role="quick-margin-para"]
You can deploy Cloud Compliance in the cloud or in an on-premises location. The only difference you will notice in the UI is the words "On-Premises Deployment".
...
The Cloud Compliance installer installs packages, installs docker, registers the installation, downloads the Cloud Compliance artifact, and installs Cloud Compliance.
...
Installation takes up to 10 minutes. When it’s done, the Compliance tab will show the Cloud Compliance Configuration page, where you can select the data sources you want to scan.
