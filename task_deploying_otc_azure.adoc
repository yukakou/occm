...
The best practice is to use a new, dedicated resource group for Cloud Volumes ONTAP. This is the default and only option when deploying Cloud Volumes ONTAP in Azure from the Cloud Manager user interface.
====
...
+
link:task_planning_your_config_azure.html#choosing-a-write-speed[Learn more about write speed].
+
