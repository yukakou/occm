...
* To deploy a BYOL system, you need the 20-digit serial number (license key) and credentials for a NetApp Support Site account, if the tenant is not already linked with an account.
