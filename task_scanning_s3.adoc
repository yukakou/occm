...
https://cloud.netapp.com/???[Learn about Cloud Compliance for Amazon S3 pricing^].

A 30-day free trial is available to scan Amazon S3 data with Cloud Compliance. A subscription to the AWS Marketplace is required to continue scanning Amazon S3 after the free trial ends. link:.html[Learn how to subscribe].
...
+
image:screenshot_settings_icon.gif[]

. Hover over the credentials for the AWS Instance Profile and click the action menu.
+
The subscription must be added to the Instance Profile. Charging won't work otherwise.

. Click *Add Subscription*.
+
image:screenshot_add_subscription.gif[]
