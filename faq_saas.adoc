...
[.lead]
This FAQ aims to answer key questions associated with the new Cloud Manager SaaS release.

== What capabilities were introduced as part of the Cloud Manager SaaS release on August 3, 2020?
...
==  I still use my Cloud Manager the same way that I did prior to this change (locally through the instance deployed in my VPC)?
...
No. It’s where it always has been--in your VPC or VNet, under your management.
