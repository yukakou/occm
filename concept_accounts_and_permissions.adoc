...
You would then link:task_adding_cloud_accounts.html[add the Cloud Provider Accounts to Cloud Manager] by specifying AWS keys for the IAM user or the Amazon Resource Name (ARN) of the IAM role.
