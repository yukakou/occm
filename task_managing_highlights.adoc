...
.. Check the box if you want emails sent to Cloud Manager users, and choose the interval at which the email is sent.
...
* Custom highlights - You can modify the _Name_, the _Description_, and whether email alert messages are sent.
* Predefined highlights - You can modify only whether email alert messages are sent.
