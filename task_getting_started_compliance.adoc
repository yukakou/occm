...
New volumes added to the working environment are scanned automatically only when the *Activate Compliance for all Volumes* setting is enabled. When this setting is disabled, you'll need to activate scanning on each new volume you create.
