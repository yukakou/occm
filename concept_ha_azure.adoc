...
The boot disk is a Premium Managed Disk.

* The boot disk for each node is a Premium Managed Disk.
* A sharable root disk is also required for HA operations. The disk resides on a Page Blob.
* Customer data resides on Premium Page Blobs.
