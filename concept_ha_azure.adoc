...
NOTE: HA pairs in Azure are available as a Preview only. You can request access by using the chat icon in the lower right of the Cloud Manager interface.
