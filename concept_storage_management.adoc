...
For step-by-step instructions and requirements for NetApp Support Site accounts, refer to link:task_setting_up_users_tenants.html#linking-tenants-to-a-netapp-support-site-account[Linking tenants to a NetApp Support Site account].
