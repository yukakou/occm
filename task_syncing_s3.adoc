...
[.lead]
You can sync data to an AWS S3 bucket by integrating a working environment with the NetApp Data Fabric Cloud Sync service. You can then use the synced data as a secondary copy or for data processing using AWS services like EMR and Redshift.
