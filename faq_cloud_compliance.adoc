...
Cloud Compliance is offered as part of Cloud Volumes ONTAP. There are no additional charges from NetApp. Additional costs might be required in the future for customized capabilities.
