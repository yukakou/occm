...
Additionally, you can use the "Data Fusion" capability to have Cloud Compliance scan your volumes and S3 buckets based on criteria found in specific columns in databases you are scanning -- essentially allowing you to make your own custom personal data types. 
