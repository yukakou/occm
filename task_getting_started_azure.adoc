...
+
NOTE: Managed Service Identities are not supported in the Azure US Gov regions and in the Germany regions. Refer to instructions for link:task_installing_azure_gov.html[US Gov regions] or for link:task_installing_azure_germany.html[Azure Germany regions] instead.
