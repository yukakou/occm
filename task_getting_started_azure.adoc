...
+
IMPORTANT: Managed Service Identities are not supported in the US Gov regions. See link:task_installing_azure_germany.html[Installing Cloud Manager in an Azure Germany region] instead.
