...
Resource charges are paid to the cloud provider for running the Backup and Restore instances in the cloud.

* For the Backup instance, you pay your cloud provider for compute and object storage costs.
+
...
* For the Restore instance, you pay your cloud provider for compute costs only when the instance is running.
+
...
NOTE: The Restore instance does not require a separate license - it is covered in your Backup to Cloud license.
