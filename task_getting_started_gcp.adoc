...
+
You'll associate this service account with the Cloud Manager VM in step 5. This service account is different from the service account that's used for data tiering.
+
