...
* Grant the Cloud Manager service account with access to this tiering service account by providing the _Service Account User_ role.
+
You can provide the user role in step 3 of the wizard when you create the tiering service account, or https://cloud.google.com/iam/docs/granting-roles-to-service-accounts#granting_access_to_a_user_for_a_service_account[grant the role after the service account was created^].
+
