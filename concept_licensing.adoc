...
****
A system that has an evaluation license behaves exactly like a system that has a regular license: if you do not renew the license in time, the Cloud Volumes ONTAP system shuts itself down until you enter a valid license. Data is not deleted from the system.
****
