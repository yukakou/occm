...
* You have subscribed to the https://azuremarketplace.microsoft.com/en-us/marketplace/apps/netapp.cloud-manager?tab=Overview[Cloud Manager Marketplace Backup offering^], or you have purchased link:task_managing_backups.html#adding_and_updating_your_backup_byol_license[and activated] a Backup to Cloud BYOL license from NetApp.
